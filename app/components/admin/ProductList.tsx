      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="text-center py-12">
          <h2 className="text-2xl font-semibold text-muted-foreground">
            {products.length === 0 ? "No products available currently." : "No products match your filters."}
          </h2>
          <p className="text-muted-foreground mt-2">
            {products.length > 0 ? "Try adjusting your search or filter criteria." : "Please check back later."}
          </p>
        </div>
      )}
    </div>
